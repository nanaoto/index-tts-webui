...
def create_model(language="zh"):
    ...
    snapshot_download(model_id="iic/speech_fsmn_vad_zh-cn-16k-common-pytorch",local_dir=path_vad)
    snapshot_download(model_id="iic/punc_ct-transformer_zh-cn-common-vocab272727-pytorch",local_dir=path_punc)

    vad_model_revision = punc_model_revision = "v2.0.4"

    if language == "zh":
        path_asr = 'tools/asr/models/speech_paraformer-large_asr_nat-zh-cn-16k-common-vocab8404-pytorch'
        snapshot_download(model_id="iic/speech_paraformer-large_asr_nat-zh-cn-16k-common-vocab8404-pytorch",local_dir=path_asr)
        model_revision = "v2.0.4"
    elif language == "yue":
        path_asr = 'tools/asr/models/speech_UniASR_asr_2pass-cantonese-CHS-16k-common-vocab1468-tensorflow1-online'
        snapshot_download(model_id="iic/speech_UniASR_asr_2pass-cantonese-CHS-16k-common-vocab1468-tensorflow1-online",local_dir=path_asr)
